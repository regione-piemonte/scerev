...
******************************************************************************/
package it.csi.scerev.scadenzaassistenza.notificatore;
...
public class NotificatoreUtil {
	...
	private String getJsonBody(String webService, String cfDestinatario, String recipient, Map<String, String> replacements) {
		...
		joPLoad.put("tag", "sanita,r_piemon,medico,pediatra,cambio,comunicazioni");
		...
		if (prop.getProperty(webService + "_email_subject_"+recipient) != null) {
			...
			joEmail.put("subject", replace(prop.getProperty(webService + "_email_subject_"+recipient), replacements));
