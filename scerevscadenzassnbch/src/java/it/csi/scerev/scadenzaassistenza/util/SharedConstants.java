...
public class SharedConstants {
	...
	// Deleghe
	public final static String DELEGHE = "DELEGHE";
	public final static String DELEGHE_USERNAME = "DELEGHE_USERNAME";
	public final static String DELEGHE_PASSWORD = "DELEGHE_PASSWORD";
