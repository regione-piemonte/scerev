...
java -cp %SWAGGER_CP% %DEBUG_OPTS% io.swagger.codegen.SwaggerCodegen generate -i ..\src\yaml\scerevboweb.yaml -l jaxrs-resteasy-eap-csi -o .. --config swagger_config_java.json

rem echo
rem pause "#### generazione stub angular2 ####"
rem java -cp %SWAGGER_CP% %DEBUG_OPTS% io.swagger.codegen.SwaggerCodegen generate -i ..\src\yaml\scerevboweb.yaml -l typescript-angular -o ..\..\scerevbowebapi --config swagger_config_angular.json 
