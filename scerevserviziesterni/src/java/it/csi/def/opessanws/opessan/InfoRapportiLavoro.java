 ...
 *       &lt;sequence>
 *         &lt;element name="info" type="{http://opessan.opessanws.def.csi.it/}InfoRapportoDiLavoro" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class InfoRapportiLavoro {
    ...
    protected List<InfoRapportoDiLavoro> info;
     ...
     * 
     */
    public List<InfoRapportoDiLavoro> getInfo() {
        if (info == null) {
            info = new ArrayList<InfoRapportoDiLavoro>();
        }
        return this.info;
    }
