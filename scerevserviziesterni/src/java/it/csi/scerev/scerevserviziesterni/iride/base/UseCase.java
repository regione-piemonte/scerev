...
public class UseCase  implements java.io.Serializable {
    private it.csi.scerev.scerevserviziesterni.iride.base.Application appId;
    ...
    public UseCase(
           it.csi.scerev.scerevserviziesterni.iride.base.Application appId,
           java.lang.String id) {
           this.appId = appId;
           this.id = id;
    }
     ...
     * @return appId
     */
    public it.csi.scerev.scerevserviziesterni.iride.base.Application getAppId() {
        return appId;
    }
     ...
     * @param appId
     */
    public void setAppId(it.csi.scerev.scerevserviziesterni.iride.base.Application appId) {
        this.appId = appId;
    }
