...
public interface AnagrafeFindSoap {
     ...
     * @return
     *     returns it.csi.scerev.scerevboweb.serviziesterni.aura.find.DatiAnagraficiMsg
     */
    ...
    @RequestWrapper(localName = "FindProfiliAnagrafici", targetNamespace = "http://AnagrafeFind.central.services.auraws.aura.csi.it", className = "it.csi.scerev.scerevboweb.serviziesterni.aura.find.FindProfiliAnagrafici")
    @ResponseWrapper(localName = "FindProfiliAnagraficiResponse", targetNamespace = "http://AnagrafeFind.central.services.auraws.aura.csi.it", className = "it.csi.scerev.scerevboweb.serviziesterni.aura.find.FindProfiliAnagraficiResponse")
