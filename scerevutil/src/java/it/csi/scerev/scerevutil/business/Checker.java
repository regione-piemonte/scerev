...
public class Checker {
	...
	public static boolean isCodiceFiscale(String codice) {
		if (!isAlfanumericcString(codice))
			return false;
		return isCodiceFiscale(codice, "TRUE");
	}
	 ...
	 * @return boolean
	 */
	public static boolean isCodiceFiscale(String codice, String test) {
...
//		}
		...
		if (codice.length() == 16) {
			if ((!isAlfabeticString(codice.substring(0, 6))) || (!isAlfabeticString(codice.substring(8, 9))) 
					|| (!isAlfabeticString(codice.substring(11, 12))) || (!isAlfabeticString(codice.substring(15, 16)))) {
				return false;
			}
			//controllo codice fiscale mascherato esteso a esenred 1
			if (!test.equalsIgnoreCase("TRUE")) {
		...
		} else if (codice.length() == 11) { //CF provvisori da 11 cifre
			if(!isNumericString(codice))  {
				return false;
			}
		} else return false;
	...
	private static boolean isCodiceFiscaleCorretto(String codice) {
		...
		Integer valoreDaDecodificare = new Integer(resto);
	 ...
	 * @version 0.1
	 */
	public static boolean isCodiceFiscaleCoerente(String codiceFiscale, String cognome, String nome, String sesso, Date dataNascita, String comune) {
		//controllo codice fiscale mascherato esteso a esenred 1
		if (isCodiceFiscale(codiceFiscale, "TRUE")) {
			...
			if (codiceFiscaleGenerato.length() != 16)
				return false;
			if (codiceFiscale.substring(0, 15).equalsIgnoreCase(codiceFiscaleGenerato.substring(0, 15)))
				return true;
			return false;
		} else
			return false;
	...
	public static String getCodiceFiscale(String cognome, String nome, String sesso, Date data, String comune) {
		...
		if (sesso.equals("M")) {
			cod.append(String.format("%02d", new Integer(giorno)));
		} else {
			giorno += 40;
			cod.append(giorno + "");
		}
		...
		codfisc.append(Character.toUpperCase(Character.forDigit(((somma % 26) + 10), 36)));
	...
	public static int getLunghezzaCodiceIBANPerNazione(String key) {
		...
		// IBAN
		paesi.put("AD", new Integer(24)); // Andorra
		paesi.put("AT", new Integer(20)); // Austria
		paesi.put("BE", new Integer(16)); // Belgio
		paesi.put("BA", new Integer(20)); // Bosnia Hercegovina
		paesi.put("BG", new Integer(22)); // Bulgaria
		paesi.put("CY", new Integer(28)); // Cipro
		paesi.put("HR", new Integer(21)); // Croazia
		paesi.put("DK", new Integer(18)); // Danimarca
		paesi.put("EE", new Integer(20)); // Estonia
		paesi.put("FI", new Integer(18)); // Finlandia
		paesi.put("FR", new Integer(27)); // Francia
		paesi.put("DE", new Integer(22)); // Germania
		paesi.put("GI", new Integer(23)); // Gibilterra
		paesi.put("GB", new Integer(22)); // Gran Bretagna
		paesi.put("GR", new Integer(27)); // Grecia
		paesi.put("IE", new Integer(22)); // Irlanda
		paesi.put("IS", new Integer(26)); // Islanda
		paesi.put("IL", new Integer(23)); // Israele
		paesi.put("IT", new Integer(27)); // Italia
		paesi.put("LV", new Integer(21)); // Lettonia
		paesi.put("LI", new Integer(21)); // Liechtenstein
		paesi.put("LT", new Integer(20)); // Lituania
		paesi.put("LU", new Integer(20)); // Lussemburgo
		paesi.put("MK", new Integer(19)); // Macedonia
		paesi.put("MT", new Integer(31)); // Malta
		paesi.put("MU", new Integer(30)); // Mauritius
		paesi.put("MC", new Integer(27)); // Monaco
		paesi.put("ME", new Integer(22)); // Montenegro
		paesi.put("NL", new Integer(18)); // Olanda
		paesi.put("NO", new Integer(15)); // Norvegia
		paesi.put("PL", new Integer(28)); // Polonia
		paesi.put("PT", new Integer(25)); // Portogallo
		paesi.put("CZ", new Integer(24)); // Repubblica Ceca
		paesi.put("RO", new Integer(24)); // Romania
		paesi.put("SM", new Integer(27)); // San Marino
		paesi.put("RS", new Integer(22)); // Serbia
		paesi.put("SK", new Integer(24)); // Slovacchia
		paesi.put("SI", new Integer(19)); // Slovenia
		paesi.put("ES", new Integer(24)); // Spagna
		paesi.put("SE", new Integer(24)); // Svezia
		paesi.put("CH", new Integer(21)); // Svizzera
		paesi.put("TN", new Integer(24)); // Tunisia
		paesi.put("TR", new Integer(26)); // Turchia
		paesi.put("HU", new Integer(28)); // Ungheria
