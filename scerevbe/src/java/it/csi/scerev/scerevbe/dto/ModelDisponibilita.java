...
public class ModelDisponibilita   {
  ...
  /**
   * true se il medico � monitorabile, false altrimenti
   **/
  


  // nome originario nello yaml: monitorabile 
  ...
  /**
   * true se � possibile selezionare il medico, false altrimenti
   **/
  


  // nome originario nello yaml: selezionabile 
  ...
  /**
   * true se � possibile selezionare il medico per un ricongiungimento familiare, false altrimenti
   **/
  


  // nome originario nello yaml: selezionabileRicongiungimentoFamiliare 
  ...
  /**
   * true se � possibile selezionare il medico per assistenza temporanea, false altrimenti
   **/
  


  // nome originario nello yaml: selezionabileAssistenzaTemporanea 
  ...
  /**
   * true se � possibile selezionare il medico (solitamente il pediatra) per assistenza di bambini da 0 a 6 anni, false altrimenti
   **/
  


  // nome originario nello yaml: selezionabileInfanzia 
  ...
  // nome originario nello yaml: medicoId 
  ...
  // nome originario nello yaml: medicoCodiceFiscale 
